...
@Component({
    selector: 'app-prove-varie-notracking',
  templateUrl: './prove-varie-notracking.component.html',
  styleUrls: ['./prove-varie-notracking.component.scss']
})
export class ProveVarieComponentNoTracking implements OnInit {
    formId: string = null;
        ...
        this.loadingFormService.submitForm(userSubmit).subscribe(data => {
            ...
            if (!data) {
                ...
                if (this.actionOnSubmit == 'saveExit') {
                    this.router.navigate(['/loading-form/utente-notracking']);
                }
            }
        }, error => {
            this.loading = false;
